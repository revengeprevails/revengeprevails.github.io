                  ...
                  <Accordion>
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="0">
                        <Card.Body>
                        <div className="py-3">
                          {item.lineup.map(contributor => {
                            return(<p className="text-light">{contributor.name}: {contributor.contribution}</p>)
                            })}
                        </div>
                        </Card.Body>
                      </Accordion.Collapse>
