    ...
    switch (year) {
      ...
      case '19':
       ...
       case '18':
        ...
        break;
        case '15':
        text = 'The four members began constructing a new rehearsal and studio. The Laboratory v.2 - a place to practice their dark art and to record forthcoming devilish musick. It stood complete in 2016 and within these mystic walls, the work for their next massive full-length album was ongoing. '
        break;
        case '14':
        ...
        break;
        case '09':
        text = 'Revenge Prevails preformed their first live show with past members who decided to quit in 2010. '
        break;
        case '08':
      ...
      <Row className="bg-spots-light justify-content-center text-center py-md-5 py-0 biography">
        <Col className="col-md-10 col-12 py-5">
          ...
          <Row className="py-md-5 py-0">
            <Col>
              <button className="biography-btn active-year" id="20" onClick={(e) => this.handleClick('20')}><h3>2020</h3></button>
            </Col>
            <Col>
